          ...
          <div className="w-full max-w-sm mx-auto space-y-8">
            ...
            <div className="space-y-4">
              {!isFirebaseConfigured && (
                <div className="bg-amber-50 border border-amber-200 p-4 rounded-md flex gap-3 text-left">
                  <AlertCircle
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-amber-700 leading-relaxed">
                      Please open the <code>.env</code> file in your project
                      root and paste your <code>VITE_FIREBASE_API_KEY</code> and{" "}
