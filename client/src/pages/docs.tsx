    ...
    <div className="min-h-screen bg-background text-foreground font-sans p-6 sm:p-12 lg:p-24">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="space-y-16">
          ...
          {/* Study Squads */}
          <section id="clans" className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-purple-500/10 rounded-xl">
                <Users className="h-6 w-6 text-purple-600 dark:text-purple-400" />
              </div>
              <div>
                <h2 className="text-2xl font-bold">Study Squads (Clans)</h2>
                <p className="text-sm text-muted-foreground">
                  Form teams and compete with classmates
                </p>
              </div>
            </div>
            ...
            <div className="bg-muted/20 rounded-xl p-8 border space-y-4">
              ...
              >
                ...
                <circle
                  ...
                  className="text-primary/20"
                />
                {/* Crown on first member */}
                <polygon
                  points="200,55 190,70 210,70"
                  fill="currentColor"
              ...
              <div className="space-y-4 pt-4">
                ...
                <ul className="space-y-3">
                  <li className="flex gap-3">
                    <span className="text-primary">✓</span>
                    <div>
                      <strong>Create or Join Teams</strong> - Form study groups
                  ...
                  <li className="flex gap-3">
                    <span className="text-primary">✓</span>
                    <div>
                      <strong>Squad Leader</strong> - Founder gets special
                      privileges (edit name, description, badge)
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary">✓</span>
                    <div>
                      <strong>Squad XP</strong> - Combined total XP of all
                      members determines leaderboard rank
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary">✓</span>
                    <div>
                      <strong>Invite System</strong> - Share your unique Clan ID
                      to invite friends
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary">✓</span>
                    <div>
                      <strong>Custom Badges</strong> - Choose from 12 unique
                      icons (Warrior, Shield, Rocket, etc.)
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-4">
              <p className="text-sm">
                <strong>💡 Pro Tip:</strong> Copy your Clan ID from settings and
                share it with friends to grow your squad!
              </p>
            </div>
          </section>
